...
#ifndef __SOP_PoissionDiscSample_h__
#define __SOP_PoissionDiscSample_h__
...
class SOP_PoissionDiscSample : public SOP_Node
{
public:
    static PRM_Template *buildTemplates();
    static OP_Node *myConstructor(OP_Network *net, const char *name, OP_Operator *op)
    {
        return new SOP_PoissionDiscSample(net, name, op);
    }
...
protected:
    SOP_PoissionDiscSample(OP_Network *net, const char *name, OP_Operator *op)
    ...
    virtual ~SOP_PoissionDiscSample() {}
